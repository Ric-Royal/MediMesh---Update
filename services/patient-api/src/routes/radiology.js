...
router.get('/study-catalog', authorize(['doctor', 'nurse', 'admin', 'radiologist']), async (req, res) => {
  try {
    const db = getDB();
...
router.get('/tests', authorize(['doctor', 'nurse', 'admin', 'radiologist']), async (req, res) => {
  try {
...
router.get('/modalities', authorize(['doctor', 'nurse', 'admin', 'radiologist']), async (req, res) => {
  try {
...
router.get('/orders', authorize(['doctor', 'nurse', 'admin', 'radiologist']), async (req, res) => {
  try {
...
router.get('/orders/:id', authorize(['doctor', 'nurse', 'admin', 'radiologist']), async (req, res) => {
  try {
    const { id } = req.params;
...
// Get radiology queue
router.get('/queue', authorize(['doctor', 'nurse', 'admin', 'radiologist']), async (req, res) => {
  try {
    const query = `
      SELECT rq.*,
...
router.get('/statistics', authorize(['doctor', 'admin', 'radiologist']), async (req, res) => {
  try {
    const query = `
      SELECT

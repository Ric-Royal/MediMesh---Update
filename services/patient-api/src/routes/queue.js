...
router.get('/', authorize(['doctor', 'nurse', 'admin', 'receptionist', 'lab-tech', 'pharmacist', 'radiologist', 'billing']), async (req, res) => {
  try {
...
router.put('/:id/status', authorize(['doctor', 'nurse', 'admin', 'receptionist', 'lab-tech', 'pharmacist', 'radiologist', 'billing']), async (req, res) => {
  try {
    const { id } = req.params;
...
router.put('/:id/move', authorize(['nurse', 'admin']), async (req, res) => {
  try {
    const { id } = req.params;

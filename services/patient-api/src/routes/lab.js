...
router.get('/test-catalog', authorize(['doctor', 'nurse', 'admin', 'lab-tech']), async (req, res) => {
  try {
    const db = getDB();
...
// Get all lab tests
router.get('/tests', authorize(['doctor', 'nurse', 'admin', 'lab-tech']), async (req, res) => {
  try {
    const db = getDB();
...
// Get test by ID
router.get('/tests/:id', authorize(['doctor', 'nurse', 'admin', 'lab-tech']), async (req, res) => {
  try {
    const db = getDB();
    const { id } = req.params;
...
router.get('/orders', authorize(['doctor', 'nurse', 'admin', 'lab-tech']), async (req, res) => {
  try {
...
router.get('/orders/:id', authorize(['doctor', 'nurse', 'admin', 'lab-tech']), async (req, res) => {
  try {
    const { id } = req.params;
...
router.put('/orders/:id/status', authorize(['doctor', 'lab-tech', 'admin']), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post('/orders/:id/collect', authorize(['lab-tech', 'nurse', 'admin']), async (req, res) => {
  const client = await getDB().connect();
  try {
    await client.query('BEGIN');
...
router.get('/queue', authorize(['doctor', 'nurse', 'admin', 'lab-tech']), async (req, res) => {
  try {
    const query = `
      SELECT lq.*,
...
// Get lab statistics
router.get('/statistics', authorize(['doctor', 'admin', 'lab-tech']), async (req, res) => {
  try {
    const query = `
      SELECT
